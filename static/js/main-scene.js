    ...
    constructor(context, control_box)     // The scene begins by requesting the camera, shapes, and materials it will need.
      {
        ...
        this.materials =
        {
          ...
          apple: context.get_instance( Phong_Shader ).material(Color.of(0,0,0,1),
                 {
                   ambient: 1,
                   specularity: 0,
                   texture: context.get_instance("/static/assets/snake3d/apple.jpg")
                 }),
          snake_skin: context.get_instance( Phong_Shader ).material(Color.of(0,0,0,1),
                 {
                   ambient: 1,
                   specularity: 0,
                   texture: context.get_instance("/static/assets/snake3d/snake3.png")
                 }),
          ...
          floor: context.get_instance(Phong_Shader).material(Color.of(0,0,0,1),
                 {
                   ambient: .8,
                   texture: context.get_instance("/static/assets/snake3d/floor.jpg", true)
                 }),
          walls: context.get_instance(Phong_Shader).material(Color.of(0,0,0,1),
                {
                 ambient: 1,
                 texture: context.get_instance("/static/assets/snake3d/walls.jpg", true)
                }),
          sky : context.get_instance(Phong_Shader).material(Color.of(0,0,0,1),
                {
                    ambient: 1,
                    texture: context.get_instance("/static/assets/snake3d/sky.png", true)
                }),
          'text_image': context.get_instance(Phong_Shader).material(Color.of(1, 1, 1, 1), {
            ambient: 1,
            diffusivity: 0,
            specularity: 0,
            texture: context.get_instance("/static/assets/snake3d/black_text.png", false)
          })
        }
